...
class MyNumber
{
    ...
    void search(int n)
    {
        ...
        if(isfound) System.out.print("This Number Is Found on "+(i+1)+" Position");
        else System.out.print("This Number Is Not Found");
    }
        ...
        do{
            ...
            switch(choice)
            {
                ...
                case 3:
                    if(!mn.isEmpty())
                    {
                        System.out.println("Enter Which Number Will Be Deleted");
                        x=sc.nextInt();
                        mn.delete(x);
                    }
                    else {
